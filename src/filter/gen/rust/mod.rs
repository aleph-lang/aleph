...
fn gen(ast: at, indent: i64) -> String {
    ...
    match ast {
        ...
        at::Tuple{elems} => format!("({})", gen_list_expr(elems, gen, Some(","))),
        at::Array{elems} => format!("[{}]", gen_list_expr(elems, gen, Some(","))),
        ...
        at::LetRec{name, args, body} => format!("{}fn {}({}) {{\n{}\n{}}}", c_indent, name, gen_list_expr(args, gen, Some(",")), gen(*body, indent+1), c_indent),
        ...
        at::Match{expr, case_list} => format!("{}match {} {{\n{}\n{}}}", c_indent, gen(*expr, 0), gen_list_expr(case_list, gen, Some(",")), c_indent),
        ...
        at::App{object_name, fun, param_list} => format!("{}{}{}({})",c_indent, (if object_name.ne("") {format!("{}.", object_name)} else {String::from("")}), gen(*fun, 0), gen_list_expr(param_list, gen, Some(","))),
