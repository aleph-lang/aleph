...
use crate::filter::gen::{gen_list_expr, gen_list_expr_sep, comp_indent};
...
fn gen(ast: at, indent: i64) -> String {
    ...
    match ast {
        ...
        at::App{object_name, fun, param_list} => format!("{}{}{}({})",c_indent, (if object_name.ne("") {format!("{}.", object_name)} else {String::from("")}), gen(*fun, 0), gen_list_expr_sep(param_list, gen, ", ")),
