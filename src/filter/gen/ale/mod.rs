...
fn gen(ast: at, indent: i64) -> String {
    ...
    match ast {
        ...
        at::Tuple{elems} => format!("{}", gen_list_expr(elems, gen, None)),
        at::Array{elems} => format!("{}", gen_list_expr(elems, gen, None)),
        ...
        at::LetRec{name, args, body} => format!("{}fun {}({}) = {{\n{}\n{}}}", c_indent, name, gen_list_expr(args, gen, None), gen(*body, indent+1), c_indent),
        ...
        at::Match{expr, case_list} => format!("{}match {} with\n{}", c_indent, gen(*expr, 0), gen_list_expr(case_list, gen, None)),
        ...
        at::App{object_name, fun, param_list} => format!("{}{}{}({})",c_indent, (if object_name.ne("") {format!("{}.", object_name)} else {String::from("")}), gen(*fun, 0), gen_list_expr(param_list, gen, None)),
